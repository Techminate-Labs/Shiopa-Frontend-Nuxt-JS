<template>
	<div class="flex min-h-screen bg-white flex-wrap">
		<div 
			...
			style="background-image: url(https://bsmedia.business-standard.com/_media/bs/img/article/2020-09/18/full/1600370225-9124.jpg)">
		</div>
		<div class="w-full md:w-1/2 flex flex-col">
			...
			<div class="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
				...
				<form class="flex flex-col pt-2 md:pt-4" :onSubmit="event.preventDefault()">
