<template>
	<div class="lg:w-1/2">
		<div class="flex flex-wrap w-full mb-6 lg:mb-0">
		...
		<div class="w-full inline-flex justify-items-end lg:justify-end float-left lg:ml-0">
...
import ArrowRight from '@/assets/icons/ArrowRight.vue'
  ...
  export default class DealOfTheDay extends Vue {}
</script>